<?PHP
include"config.php";
$query=mysql_query("SELECT * FROM data_kelurahan WHERE id_data=8");
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="data/act_edit_data_desa.php" method="post" enctype="multipart/form-data">
          ...
          <div id="contentname">
            <input name="save" type="submit"class="btn btn-primary pull-right" value="Edit LPM"  />
            <div id="ket"></div>
          </div>
          <div id="ket"></div>
        </form>
