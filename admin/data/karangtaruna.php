<?PHP
include"config.php";
$query=mysql_query("SELECT * FROM data_kelurahan WHERE id_data=7");
...
?>
    <div class="panel panel-default">
      <div class="panel-heading">
        <div class="row">
          <div class="col-lg-6">
            <h3 class="panel-title">Karang Taruna</h3>
          </div>
          <div class="col-lg-6">
      ...
      <div class="panel-body">
        <form action="data/act_edit_data_desa.php" method="post" enctype="multipart/form-data">
          ...
          <div id="contentname">
            <input name="save" type="submit"class="btn btn-primary pull-right" value="Edit Karang Taruna
            "  />
            <div id="ket"></div>
          </div>
          <div id="ket"></div>
